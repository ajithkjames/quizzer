...
urlpatterns = [
   ...
   url(r'^leader-board/city/(?P<city>[0-9]+)/(?P<pk>[0-9]+)/$', views.LeaderCity.as_view(), name='leader_city'),
   url(r'^leader-board/school/(?P<school>[0-9]+)/(?P<pk>[0-9]+)/$', views.LeaderSchool.as_view(), name='leader_school'),
